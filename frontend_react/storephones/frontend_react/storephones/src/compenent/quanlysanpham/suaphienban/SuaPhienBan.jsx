                    ...
                    <div className="menu6">
                        ...
                        <div className="content-edit">
                            <div className="select-img-edit">
                                <img className="img-selected-edit2" src={formUpdatePhienBan.image.length > 0 && formUpdatePhienBan.image[imgNow] instanceof File
                                    ? URL.createObjectURL(formUpdatePhienBan.image[imgNow])
                                    : (formUpdatePhienBan.image.length>0 ? formUpdatePhienBan.image[imgNow].url : null)} />
