...
import PhanTrang from "../quanlysanpham/phantrang/PhanTrang";

function ShowDSDienThoai({ dsPhienBan, clickXemChiTiet, searchAndFilter, clickTieuChi, clickFilter, page, totalPage, clickChangePage }) {
    ...
    return (
        <>
            ...
            <PhanTrang page={page} totalPage={totalPage} clickChangePage={clickChangePage} />
        </>
    )
}
